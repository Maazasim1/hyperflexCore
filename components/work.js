    ...
    <div className='pt-20'>
        ...
        <div className='relative'>
          <div className='relative shadow-2xl shadow-gray-700  rounded-3xl overflow-hidden'>
            <Image src={props.mainImageUrl} width={1366} height={768} />
          </div>
        </div>
      </motion.div>
        ...
        <div className='flex space-y-4 justify-center items-center flex-row'>
          <div className='shrink w-[80%]'>
            ...
            <div>
              ...
              <p className='pb-10 uppercase font-poppins font-semibold text-[20px] text-gray-500'>
                result
              </p>
            ...
            <div>
              <p className='text-[20px] font-poppins font-extrabold uppercase text-gray-500'>Technologies <span className='text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-blue-600'>{props.tech}</span></p>
            </div>
          </div>
          <div className='overflow-hidden flex-grow'>
            <Image src={props.secondImageUrl} width={700} height={700} />
          </div>
